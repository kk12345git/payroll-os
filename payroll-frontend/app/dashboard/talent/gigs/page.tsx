                                ...
                                <form onSubmit={handleApply} className="space-y-8">
                                    ...
                                    <div className="p-6 bg-slate-900 rounded-2xl flex items-center gap-6">
                                        ...
                                        <p className="text-[10px] font-bold text-slate-400 uppercase tracking-[0.1em] leading-relaxed">
                                            By applying, you agree that this gig is an <span className="text-white">internal project</span> and compensation will be added to your <span className="text-white">next payroll cycle</span> upon completion.
                                        </p>
                                    </div>
