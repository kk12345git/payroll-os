...
const MOCK_NOTIFICATIONS: NotificationSetting[] = [
    // AutoPay-OS
    { id: '1', category: 'AutoPay-OS', name: 'AutoPay-OS Processed', description: 'When monthly autopay-os is processed successfully', email: true, inApp: true },
    ...
    { id: '3', category: 'AutoPay-OS', name: 'AutoPay-OS Errors', description: 'When errors occur during autopay-os processing', email: true, inApp: true },
