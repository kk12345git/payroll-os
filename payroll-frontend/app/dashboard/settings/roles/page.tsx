...
const ALL_PERMISSIONS = [
    ...
    'view_autopay-os', 'process_autopay-os', 'edit_autopay-os',
...
const MOCK_ROLES: Role[] = [
    ...
    { id: '2', name: 'HR Manager', description: 'Manage employees and autopay-os', permissions: ['view_employees', 'add_employees', 'edit_employees', 'view_autopay-os', 'process_autopay-os', 'approve_leaves', 'view_reports'] },
                ...
                <div className="lg:col-span-2 card-extreme">
                    ...
                    <div className="space-y-6">
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                {['view_autopay-os', 'process_autopay-os', 'edit_autopay-os'].map(permission => (
                                    <label
                                        key={permission}
                                        className={`flex items-center justify-between p-4 rounded-xl border-2 cursor-pointer transition-all ${hasPermission(permission)
                                                ? 'bg-green-50 border-green-500'
