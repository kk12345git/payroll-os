...
export default function RunAutoPayOSPage() {
    ...
    const currentMonthRecords = useMemo(() => {
        return payrollRecords.filter(r => r.month === month && r.year === year);
                        ...
                        >
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs font-bold text-slate-400 uppercase tracking-widest">Choose payroll period</p>
                                </div>
                            </div>
                            <select
                                value={selectedMonth}
                            ...
                            {!processed && stats.pending > 0 ? (
                                <>
                                    ...
                                    <motion.button
                                        ...
                                        className={`w-full py-4 rounded-2xl font-black uppercase tracking-widest text-xs transition-all flex items-center justify-center gap-3 ${payrollLoading
