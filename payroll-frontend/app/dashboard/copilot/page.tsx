...
export default function AICopilotPage() {
    const [messages, setMessages] = useState<Message[]>([
        {
            id: 'welcome',
            text: "Hello! I'm your AI Admin Copilot. Ask me anything about your payroll, headcount, or department costs.",
            sender: 'bot',
            timestamp: new Date()
        }
    ]);
                ...
                <div className="hidden lg:flex flex-col w-80 gap-6">
                    <div className="card-extreme p-6 bg-indigo-900 text-white overflow-hidden relative">
                        ...
                        <p className="text-sm text-indigo-100/80 leading-relaxed relative z-10">
                            The AI Copilot understands specific payroll metrics. Try asking about trends, high earners, or departmental costs.
                        </p>
                    </div>
