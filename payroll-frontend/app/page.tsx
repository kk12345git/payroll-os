    ...
    >
      ...
      <section className="relative pt-40 pb-20 px-6">
        <div className="max-w-5xl mx-auto text-center relative z-10 flex flex-col items-center">
          ...
          >
            The autopay-os platform <br className="hidden md:block" />
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white/5 border border-white/10 p-8 rounded-3xl hover:bg-white/[0.07] transition-colors group flex flex-col">
              ...
              <p className="text-slate-400 leading-relaxed mb-8">Execute autopay-os runs in milliseconds. Connect your corporate treasury for 1-click global payouts.</p>
      ...
      <section className="py-32 px-6" id="customers">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { quote: "It replaced three different legacy systems within our first month. The automation alone saves us 40 hours per autopay-os cycle.", author: "Sarah Jenkins", role: "VP People", co: "TechCorp" },
      ...
      <section className="py-32 px-6 relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto text-center relative z-10">
          <h2 className="text-4xl md:text-5xl font-bold tracking-tight mb-8">Ready to upgrade your autopay-os?</h2>
      ...
      <footer className="pt-20 pb-10 px-6 bg-[#020617]">
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-5 gap-12 mb-16">
          <div className="col-span-2 lg:col-span-2">
            ...
            <p className="text-slate-400 mb-6 max-w-sm text-sm">The intelligent autopay-os platform designed to scale with your business natively, anywhere in the world.</p>
